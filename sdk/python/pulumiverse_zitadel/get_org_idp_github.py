...
__all__ = [
    'GetOrgIdpGithubResult',
    'AwaitableGetOrgIdpGithubResult',
    'get_org_idp_github',
    'get_org_idp_github_output',
]

@pulumi.output_type
class GetOrgIdpGithubResult:
    """
...
class AwaitableGetOrgIdpGithubResult(GetOrgIdpGithubResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOrgIdpGithubResult(
...
def get_org_idp_github(id: Optional[str] = None,
                       org_id: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrgIdpGithubResult:
    """
    ...
    github = zitadel.get_org_idp_github(id="177073614158299139")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zitadel:index/getOrgIdpGithub:getOrgIdpGithub', __args__, opts=opts, typ=GetOrgIdpGithubResult).value

    return AwaitableGetOrgIdpGithubResult(
...
@_utilities.lift_output_func(get_org_idp_github)
def get_org_idp_github_output(id: Optional[pulumi.Input[str]] = None,
                              org_id: Optional[pulumi.Input[str]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOrgIdpGithubResult]:
    """
    Datasource representing a GitHub IdP of the organization.
