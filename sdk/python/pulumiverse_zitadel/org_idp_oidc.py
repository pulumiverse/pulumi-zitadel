...
class OrgIdpOidcArgs:
    def __init__(__self__, *,
        ...
        OrgIdpOidcArgs._configure(
            ...
            is_id_token_mapping=is_id_token_mapping,
    ...
    def _configure(
        ...
        if 'isIdTokenMapping' in kwargs:
            is_id_token_mapping = kwargs['isIdTokenMapping']
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            OrgIdpOidcArgs._configure(_setter, **kwargs)
