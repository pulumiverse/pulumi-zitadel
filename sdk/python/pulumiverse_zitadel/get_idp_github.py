...
__all__ = [
    'GetIdpGithubResult',
    'AwaitableGetIdpGithubResult',
    'get_idp_github',
    'get_idp_github_output',
]

@pulumi.output_type
class GetIdpGithubResult:
    """
...
class AwaitableGetIdpGithubResult(GetIdpGithubResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIdpGithubResult(
...
def get_idp_github(id: Optional[str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIdpGithubResult:
    """
    ...
    github = zitadel.get_idp_github(id="177073614158299139")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zitadel:index/getIdpGithub:getIdpGithub', __args__, opts=opts, typ=GetIdpGithubResult).value

    return AwaitableGetIdpGithubResult(
...
@_utilities.lift_output_func(get_idp_github)
def get_idp_github_output(id: Optional[pulumi.Input[str]] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIdpGithubResult]:
    """
    Datasource representing a GitHub IDP on the instance.
