...
__all__ = [
    ...
    'AwaitableGetOrgIdpOauthResult',
    'get_org_idp_oauth',
    'get_org_idp_oauth_output',
]

@pulumi.output_type
class GetOrgIdpOauthResult:
    """
    A collection of values returned by getOrgIdpOauth.
    """
    def __init__(__self__, authorization_endpoint=None, client_id=None, client_secret=None, id=None, id_attribute=None, is_auto_creation=None, is_auto_update=None, is_creation_allowed=None, is_linking_allowed=None, name=None, org_id=None, scopes=None, token_endpoint=None, user_endpoint=None):
...
class AwaitableGetOrgIdpOauthResult(GetOrgIdpOauthResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOrgIdpOauthResult(
...
def get_org_idp_oauth(id: Optional[str] = None,
                      ...
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrgIdpOauthResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('zitadel:index/getOrgIdpOauth:getOrgIdpOauth', __args__, opts=opts, typ=GetOrgIdpOauthResult).value

    return AwaitableGetOrgIdpOauthResult(
...
@_utilities.lift_output_func(get_org_idp_oauth)
def get_org_idp_oauth_output(id: Optional[pulumi.Input[str]] = None,
                             org_id: Optional[pulumi.Input[Optional[str]]] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOrgIdpOauthResult]:
    """
    Datasource representing a generic OAuth2 IDP of the organization.
