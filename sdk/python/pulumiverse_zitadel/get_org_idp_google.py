...
__all__ = [
    ...
    'AwaitableGetOrgIdpGoogleResult',
    'get_org_idp_google',
    'get_org_idp_google_output',
]

@pulumi.output_type
class GetOrgIdpGoogleResult:
    """
...
class AwaitableGetOrgIdpGoogleResult(GetOrgIdpGoogleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOrgIdpGoogleResult(
...
def get_org_idp_google(id: Optional[str] = None,
                       org_id: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrgIdpGoogleResult:
    """
    ...
    google = zitadel.get_org_idp_google(id="177073614158299139")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zitadel:index/getOrgIdpGoogle:getOrgIdpGoogle', __args__, opts=opts, typ=GetOrgIdpGoogleResult).value

    return AwaitableGetOrgIdpGoogleResult(
...
@_utilities.lift_output_func(get_org_idp_google)
def get_org_idp_google_output(id: Optional[pulumi.Input[str]] = None,
                              org_id: Optional[pulumi.Input[str]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOrgIdpGoogleResult]:
    """
    Datasource representing a Google IdP of the organization.
