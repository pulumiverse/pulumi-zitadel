...
__all__ = [
    ...
    'AwaitableGetOrgIdpGitlabSelfHostedResult',
    'get_org_idp_gitlab_self_hosted',
    'get_org_idp_gitlab_self_hosted_output',
]

@pulumi.output_type
class GetOrgIdpGitlabSelfHostedResult:
    """
    A collection of values returned by getOrgIdpGitlabSelfHosted.
    """
    def __init__(__self__, client_id=None, client_secret=None, id=None, is_auto_creation=None, is_auto_update=None, is_creation_allowed=None, is_linking_allowed=None, issuer=None, name=None, org_id=None, scopes=None):
...
class AwaitableGetOrgIdpGitlabSelfHostedResult(GetOrgIdpGitlabSelfHostedResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOrgIdpGitlabSelfHostedResult(
...
def get_org_idp_gitlab_self_hosted(id: Optional[str] = None,
                                   org_id: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrgIdpGitlabSelfHostedResult:
    """
