...
__all__ = [
    'GetIdpGithubEsResult',
    'AwaitableGetIdpGithubEsResult',
    'get_idp_github_es',
    'get_idp_github_es_output',
]

@pulumi.output_type
class GetIdpGithubEsResult:
    """
...
class AwaitableGetIdpGithubEsResult(GetIdpGithubEsResult):
...
def get_idp_github_es(id: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIdpGithubEsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('zitadel:index/getIdpGithubEs:getIdpGithubEs', __args__, opts=opts, typ=GetIdpGithubEsResult).value
...
@_utilities.lift_output_func(get_idp_github_es)
def get_idp_github_es_output(id: Optional[pulumi.Input[str]] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIdpGithubEsResult]:
    """
    Datasource representing a GitHub Enterprise IDP on the instance.
