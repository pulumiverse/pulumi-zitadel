...
namespace Pulumiverse.Zitadel
{
    ...
    public partial class IdpSaml : global::Pulumi.CustomResource
    {
        ...
        public IdpSaml(string name, IdpSamlArgs args, CustomResourceOptions? options = null)
            : base("zitadel:index/idpSaml:IdpSaml", name, args ?? new IdpSamlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdpSaml(string name, Input<string> id, IdpSamlState? state = null, CustomResourceOptions? options = null)
            : base("zitadel:index/idpSaml:IdpSaml", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IdpSaml Get(string name, Input<string> id, IdpSamlState? state = null, CustomResourceOptions? options = null)
        {
            return new IdpSaml(name, id, state, options);
        }
    }
    ...
    public sealed class IdpSamlArgs : global::Pulumi.ResourceArgs
    {
        ...
        public static new IdpSamlArgs Empty => new IdpSamlArgs();
    }
    ...
    public sealed class IdpSamlState : global::Pulumi.ResourceArgs
    {
        ...
        public static new IdpSamlState Empty => new IdpSamlState();
    }
}
