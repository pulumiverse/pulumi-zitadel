...
namespace Pulumiverse.Zitadel
{
    public static class GetIdpOauth
    {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetIdpOauthResult> InvokeAsync(GetIdpOauthArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIdpOauthResult>("zitadel:index/getIdpOauth:getIdpOauth", args ?? new GetIdpOauthArgs(), options.WithDefaults());
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Output<GetIdpOauthResult> Invoke(GetIdpOauthInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIdpOauthResult>("zitadel:index/getIdpOauth:getIdpOauth", args ?? new GetIdpOauthInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetIdpOauthArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetIdpOauthArgs()
        {
        }
        public static new GetIdpOauthArgs Empty => new GetIdpOauthArgs();
    }

    public sealed class GetIdpOauthInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// The ID of this resource.
        /// </summary>
        ...
        public GetIdpOauthInvokeArgs()
        {
        }
        public static new GetIdpOauthInvokeArgs Empty => new GetIdpOauthInvokeArgs();
    }


    [OutputType]
    public sealed class GetIdpOauthResult
    {
        /// <summary>
