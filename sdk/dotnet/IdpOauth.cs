...
namespace Pulumiverse.Zitadel
{
    ...
    /// ```
    /// </summary>
    [ZitadelResourceType("zitadel:index/idpOauth:IdpOauth")]
    public partial class IdpOauth : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IdpOauth(string name, IdpOauthArgs args, CustomResourceOptions? options = null)
            : base("zitadel:index/idpOauth:IdpOauth", name, args ?? new IdpOauthArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdpOauth(string name, Input<string> id, IdpOauthState? state = null, CustomResourceOptions? options = null)
            : base("zitadel:index/idpOauth:IdpOauth", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IdpOauth Get(string name, Input<string> id, IdpOauthState? state = null, CustomResourceOptions? options = null)
        {
            return new IdpOauth(name, id, state, options);
        }
    }

    public sealed class IdpOauthArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The authorization endpoint
        /// </summary>
        ...
        public static new IdpOauthArgs Empty => new IdpOauthArgs();
    }

    public sealed class IdpOauthState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The authorization endpoint
        /// </summary>
        ...
        public IdpOauthState()
        {
        }
        public static new IdpOauthState Empty => new IdpOauthState();
    }
}
