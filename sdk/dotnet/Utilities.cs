...
namespace scoretechnologies.Zitadel
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/scoretechnologies";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("scoretechnologies.Zitadel.version.txt");
    ...
    internal sealed class ZitadelResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ZitadelResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
