...
export class DefaultLoginPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultLoginPolicyState, opts?: pulumi.CustomResourceOptions): DefaultLoginPolicy {
        return new DefaultLoginPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zitadel:index/defaultLoginPolicy:DefaultLoginPolicy';

    /**
     * Returns true if the given object is an instance of DefaultLoginPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultLoginPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultLoginPolicy.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: DefaultLoginPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultLoginPolicyArgs | DefaultLoginPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultLoginPolicyState | undefined;
            ...
            const args = argsOrState as DefaultLoginPolicyArgs | undefined;
        ...
        super(DefaultLoginPolicy.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DefaultLoginPolicyState {
    /**
     * if set to true, the suffix (@domain.com) of an unknown username input on the login screen will be matched against the org domains and will redirect to the registration of that organisation on success.
     */
 ...
 */
export interface DefaultLoginPolicyArgs {
    /**
     * if set to true, the suffix (@domain.com) of an unknown username input on the login screen will be matched against the org domains and will redirect to the registration of that organisation on success.
     */
    allowDomainDiscovery?: pulumi.Input<boolean>;
