 ...
 *
 * const gitlabSelfHosted = new zitadel.OrgIdpGitlabSelfHosted("gitlabSelfHosted", {
 ...
 * ```
 */
export class OrgIdpGitlabSelfHosted extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OrgIdpGitlabSelfHostedState, opts?: pulumi.CustomResourceOptions): OrgIdpGitlabSelfHosted {
        return new OrgIdpGitlabSelfHosted(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zitadel:index/orgIdpGitlabSelfHosted:OrgIdpGitlabSelfHosted';

    /**
     * Returns true if the given object is an instance of OrgIdpGitlabSelfHosted.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OrgIdpGitlabSelfHosted {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OrgIdpGitlabSelfHosted.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: OrgIdpGitlabSelfHostedArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OrgIdpGitlabSelfHostedArgs | OrgIdpGitlabSelfHostedState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OrgIdpGitlabSelfHostedState | undefined;
            ...
            const args = argsOrState as OrgIdpGitlabSelfHostedArgs | undefined;
 ...
 */
export interface OrgIdpGitlabSelfHostedState {
    /**
     * client id generated by the identity provider
     */
 ...
 */
export interface OrgIdpGitlabSelfHostedArgs {
    /**
     * client id generated by the identity provider
     */
    clientId: pulumi.Input<string>;
