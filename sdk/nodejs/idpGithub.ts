...
export class IdpGithub extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdpGithubState, opts?: pulumi.CustomResourceOptions): IdpGithub {
        return new IdpGithub(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zitadel:index/idpGithub:IdpGithub';

    /**
     * Returns true if the given object is an instance of IdpGithub.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IdpGithub {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IdpGithub.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: IdpGithubArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IdpGithubArgs | IdpGithubState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IdpGithubState | undefined;
            ...
            const args = argsOrState as IdpGithubArgs | undefined;
 ...
 */
export interface IdpGithubState {
    /**
     * client id generated by the identity provider
     */
 ...
 */
export interface IdpGithubArgs {
    /**
     * client id generated by the identity provider
     */
    clientId: pulumi.Input<string>;
