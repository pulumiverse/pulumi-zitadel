...
export class IdpGitlabSelfHosted extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdpGitlabSelfHostedState, opts?: pulumi.CustomResourceOptions): IdpGitlabSelfHosted {
        return new IdpGitlabSelfHosted(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zitadel:index/idpGitlabSelfHosted:IdpGitlabSelfHosted';

    /**
     * Returns true if the given object is an instance of IdpGitlabSelfHosted.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IdpGitlabSelfHosted {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IdpGitlabSelfHosted.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: IdpGitlabSelfHostedArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IdpGitlabSelfHostedArgs | IdpGitlabSelfHostedState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IdpGitlabSelfHostedState | undefined;
            ...
            const args = argsOrState as IdpGitlabSelfHostedArgs | undefined;
 ...
 */
export interface IdpGitlabSelfHostedState {
    /**
     * client id generated by the identity provider
     */
 ...
 */
export interface IdpGitlabSelfHostedArgs {
    /**
     * client id generated by the identity provider
     */
    clientId: pulumi.Input<string>;
