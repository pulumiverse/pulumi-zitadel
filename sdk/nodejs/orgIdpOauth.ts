 ...
 * ```
 */
export class OrgIdpOauth extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OrgIdpOauthState, opts?: pulumi.CustomResourceOptions): OrgIdpOauth {
        return new OrgIdpOauth(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zitadel:index/orgIdpOauth:OrgIdpOauth';

    /**
     * Returns true if the given object is an instance of OrgIdpOauth.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OrgIdpOauth {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OrgIdpOauth.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: OrgIdpOauthArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OrgIdpOauthArgs | OrgIdpOauthState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OrgIdpOauthState | undefined;
            ...
            const args = argsOrState as OrgIdpOauthArgs | undefined;
        ...
        super(OrgIdpOauth.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface OrgIdpOauthState {
    /**
     * The authorization endpoint
     */
 ...
 */
export interface OrgIdpOauthArgs {
    /**
     * The authorization endpoint
     */
    authorizationEndpoint: pulumi.Input<string>;
