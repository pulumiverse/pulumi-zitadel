...
func (o LookupOrgIdpGitlabSelfHostedResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupOrgIdpGitlabSelfHostedResult] {
	return pulumix.Output[LookupOrgIdpGitlabSelfHostedResult]{
