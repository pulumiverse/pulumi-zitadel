...
func (o LookupOrgIdpGithubResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupOrgIdpGithubResult] {
	return pulumix.Output[LookupOrgIdpGithubResult]{
