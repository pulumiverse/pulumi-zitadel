...
func (o LookupOrgIdpGoogleResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupOrgIdpGoogleResult] {
	return pulumix.Output[LookupOrgIdpGoogleResult]{
