...
func (o LookupIdpGitlabSelfHostedResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupIdpGitlabSelfHostedResult] {
	return pulumix.Output[LookupIdpGitlabSelfHostedResult]{
