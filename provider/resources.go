	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"zitadel_password_complexity_policy": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "PasswordComplexityPolicy"),
			},
			...
			"zitadel_default_notification_policy": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "DefaultNotificationPolicy"),
			},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"zitadel_org_idp_gitlab_self_hosted": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getOrgIdpGitlabSelfHosted"),
			},
